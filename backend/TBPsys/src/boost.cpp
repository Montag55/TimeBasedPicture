...
Boost::Boost( std::shared_ptr<Base> mother, int id):
...
void Boost::calc(int id, int start, int length, int sign, cv::Mat& result, float& factor) {
  std::cout<<"Boost: with work_size:"<<length<<" took ";
