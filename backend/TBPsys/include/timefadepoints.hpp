...
public:
  //KONSTRUTOREN----------------------------------------------------------------
  Timefadepoints(std::shared_ptr< Base > mother, int id, int type, int mode_distance, int mode_function, float param, std::shared_ptr< std::vector<cv::Vec4f>> points, int offset, int stride);
  ...
  void manipulate(int mode_d, int mode_f, float param, std::shared_ptr< std::vector<cv::Vec4f>> points, int offset, int stride);
